...
class _DownloadableProductScreenState extends State<DownloadableProductScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title:
            Text(_globalService.getString(Const.ACCOUNT_DOWNLOADABLE_PRODUCTS)),
      ),
  ...
  void showUserAgreementDialog(UserAgreementData data) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title:
              Text(_globalService.getString(Const.DOWNLOADABLE_USER_AGREEMENT)),
          ...
          actions: [
            TextButton(
                ...
                child:
                    Text(_globalService.getString(Const.DOWNLOADABLE_I_AGREE))),
          ],
        );
      },
    );
