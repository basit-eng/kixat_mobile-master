...
import 'package:softify/bloc/review_bloc.dart';
  ...
  Widget rootWidget(CustomerReviewData data) {
    ...
    return Stack(
      children: [
        ...
        if ((data?.productReviews?.isEmpty ?? true) == true) noDataText,
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
                '${_globalService.getString(Const.REVIEW_DATE)} ${item.writtenOnStr}'),
          ],
        ),
      ),
    );
