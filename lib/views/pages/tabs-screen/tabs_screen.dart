...
import 'package:softify/bloc/category_tree/category_tree_bloc.dart';
...
import 'package:softify/views/pages/categories/categories_screen.dart';
import 'package:softify/views/pages/drawer.dart';
import 'package:softify/views/pages/feeDetails/fee_details.dart';
import 'package:softify/views/pages/home/home_screen.dart';
import 'package:softify/views/pages/more/more_screen.dart';
import 'package:softify/views/pages/notice_screen.dart';
import 'package:softify/views/pages/report_card.dart';
import 'package:softify/views/pages/search/search_screen.dart';
