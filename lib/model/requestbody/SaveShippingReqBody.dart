...
class SaveShippingReqBody {
  ...
  factory SaveShippingReqBody.fromJson(Map<String, dynamic> json) =>
      SaveShippingReqBody(
        data: json["Data"] == null
            ? null
            : SaveShippingReqData.fromJson(json["Data"]),
...
class SaveShippingReqData {
  ...
  factory SaveShippingReqData.fromJson(Map<String, dynamic> json) =>
      SaveShippingReqData(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ShippingNewAddress":
            shippingNewAddress == null ? null : shippingNewAddress,
      };
}
