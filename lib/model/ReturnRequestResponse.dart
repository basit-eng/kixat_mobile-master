...
class ReturnRequestData {
  ...
  factory ReturnRequestData.fromJson(Map<String, dynamic> json) =>
      ReturnRequestData(
        ...
        items: json["Items"] == null
            ? null
            : List<ReturnRequestProduct>.from(
                json["Items"].map((x) => ReturnRequestProduct.fromJson(x))),
        returnRequestReasonId: json["ReturnRequestReasonId"] == null
            ? null
            : json["ReturnRequestReasonId"],
        availableReturnReasons: json["AvailableReturnReasons"] == null
            ? null
            : List<AvailableReturn>.from(json["AvailableReturnReasons"]
                .map((x) => AvailableReturn.fromJson(x))),
        returnRequestActionId: json["ReturnRequestActionId"] == null
            ? null
            : json["ReturnRequestActionId"],
        availableReturnActions: json["AvailableReturnActions"] == null
            ? null
            : List<AvailableReturn>.from(json["AvailableReturnActions"]
                .map((x) => AvailableReturn.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ReturnRequestReasonId":
            returnRequestReasonId == null ? null : returnRequestReasonId,
        ...
        "ReturnRequestActionId":
            returnRequestActionId == null ? null : returnRequestActionId,
...
class ReturnRequestProduct {
  ...
  factory ReturnRequestProduct.fromJson(Map<String, dynamic> json) =>
      ReturnRequestProduct(
