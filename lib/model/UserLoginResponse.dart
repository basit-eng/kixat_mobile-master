...
class CustomerInfo {
  ...
  factory CustomerInfo.fromJson(Map<String, dynamic> json) => CustomerInfo(
        ...
        associatedExternalAuthRecords: List<dynamic>.from(
            json["AssociatedExternalAuthRecords"].map((x) => x)),
        ...
        customerAttributes: List<CustomerAttribute>.from(
            json["CustomerAttributes"]
                .map((x) => CustomerAttribute.fromJson(x))),
        gdprConsents: List<GdprConsent>.from(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AssociatedExternalAuthRecords":
            List<dynamic>.from(associatedExternalAuthRecords.map((x) => x)),
        "NumberOfExternalAuthenticationProviders":
            numberOfExternalAuthenticationProviders,
        "AllowCustomersToRemoveAssociations":
            allowCustomersToRemoveAssociations,
