...
class CartRepository {
  ...
  Future<FileUploadResponse> uploadFile(
    ...
    final response = await _helper.multipart(
        '${Endpoints.uploadFileCheckoutAttribute}/$attributeId', filePath);
