...
import 'package:kixat/customWidget/SpecificationAttributeItem.dart';
...
import 'package:kixat/customWidget/home/horizontal_product_box_slider.dart';
...
import 'package:kixat/pages/product/item_group_product.dart';
  ...
  void initState() {
    ...
    attributeManager = CustomAttributeManager(
      ...
      onClick: (priceAdjNeeded) {
        ...
        setState(() {
          if (priceAdjNeeded) {
            _bloc.postSelectedAttributes(productId,
  ...
  Widget getProductDetailsWidget(ProductDetails data) {
    ...
    CustomButton btnAddToCart = CustomButton(
      ...
      shape: data.addToCart?.availableForPreOrder == true
        ...
        : _globalService.getAppLandingData().rtl ? ButtonShape.RoundedTopRight : ButtonShape.RoundedTopLeft,
    ...
    CustomButton btnBuyNow = CustomButton(
      ...
      shape: _globalService.getAppLandingData().rtl ? ButtonShape.RoundedTopLeft : ButtonShape.RoundedTopRight,
      ...
      onPressed: () {
        ...
        showDialog(
          ...
          builder: (_) => EstimateShippingDialog(
            data.productEstimateShipping, true, formValues: formValues,
          ),
        );
      },
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    availability,
                    attributeManager.populateCustomAttributes(data.productAttributes),
                    ratingAndReview,
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData
                    ...
                    return HorizontalSlider(
                        _globalService.getString(Const.PRODUCT_RELATED_PRODUCT), false, false, [], snapshot.data.data
                    );
                  }
                  return SizedBox.shrink();
                },
