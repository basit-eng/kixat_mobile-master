...
import 'package:kixat/customWidget/home/horizontal_categories.dart';
import 'package:kixat/customWidget/home/horizontal_manufacturer_slider.dart';
                    ...
                    return Column(
                      children: [
                        ...snapshot.data.data.data.map<Widget>((e) {
                          return HorizontalSlider(
                              e.name, true, true, e.subCategories, e.products, categoryId: e.id,);
                        }).toList(),
                      ],
                    );
                  return SizedBox.shrink();
