...
import 'package:kixat/pages/account/order/order_details_screen.dart';
import 'package:kixat/pages/checkout/checkout_webview.dart';
import 'package:kixat/pages/checkout/step_checkout_address.dart';
import 'package:kixat/pages/checkout/step_confirm_order.dart';
import 'package:kixat/pages/checkout/step_payment_methd.dart';
import 'package:kixat/pages/checkout/step_shipping_methd.dart';
        ...
        setState(() {
          switch(event.data?.data?.nextStep ?? 0) {
            ...
            case CheckoutConstants.ConfirmOrder:
              currentWidget =  StepConfirmOrder(_bloc, confirmModel: event.data?.data?.confirmModel);
              break;
