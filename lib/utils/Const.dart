class Const {
  ...
  static const HOME_NAV_HOME = "nopstation.webapi.common.home";
...
//        static const RETURN_REQ_ =;
  ...
  static const COMMON_PLEASE_WAIT = "nopstation.webapi.common.pleasewait";
  ...
  static const text1 = "nopstation.webapi.text1";
  static const text2 = "nopstation.webapi.text2";
  static const text3 = "nopstation.webapi.text3";
  //CHECKOUT;
  ...
  static const SELECT_COUNTRY = "address.selectcountry";

  static const SELECT_STATE = "address.selectstate";

  static const STATE_PROVINCE = "address.fields.stateprovince";
  static const ZIP_CODE = "address.fields.zippostalcode";

  static const ADD_NEW_ADDRESS = "account.customeraddresses.addnew";

  static const UPDATED_SUCCESSFULLY = "nopstation.webapi.updated";

  static const ADDRESS_UPDATED_SUCCESSFULLY =
      "nopstation.webapi.address.fields.addressupdated";
  static const ADDRESS_SAVED_SUCCESSFULLY =
      "nopstation.webapi.address.fields.addresssaved";

  static const CONFIRM_DELETE_ADDRESS =
      "nopstation.webapi.address.fields.confirmdeleteaddress";
  static const DELETE_ADDRESS =
      "nopstation.webapi.address.fields.deleteaddress";

  static const STREET_ADDRESS = "account.fields.streetaddress";
  static const STREET_ADDRESS_2 = "account.fields.streetaddress2";
  static const COUNTRY = "account.fields.country";
  static const COUNTRY_REQUIRED = "account.fields.country.required";
  static const STATE_REQUIRED = "account.fields.stateprovince.required";
  static const ZIP_REQUIRED = "account.fields.zippostalcode.required";

  static const IS_REQUIRED = "nopstation.webapi.common.isrequired";

  //Confirm Order;
  static const PICK_UP_POINT_ADDRESS = "order.pickupaddress";
  static const SHIPPING_METHOD = "checkout.shippingmethod";
  static const PAYMENT_METHOD = "checkout.paymentmethod";
  static const SELECTED_ATTRIBUTES =
      "nopstation.webapi.checkout.selectedattributes";
  static const ORDER_CALCULATION =
      "nopstation.webapi.checkout.ordercalculation";
  static const WILL_EARN = "shoppingcart.totals.rewardpoints.willearn";
  static const POINTS = "shoppingcart.totals.rewardpoints.willearn.point";
  static const QUANTITY = "order.product(s).quantity";
  static const PRICE = "order.product(s).price";
  static const CHECKOUT_ORDER_NUMBER = "checkout.ordernumber";
  static const CHECKOUT_ORDER_PLACED = "nopstation.webapi.order.confirmed";
  ...
  static const ONLINE_PAYMENT = "nopstation.webapi.checkout.onlinepayment";

  // Barcode;
  static const PUT_BARCODE_HERE = "nopstation.webapi.barcode.putbarcodehere";
  static const INconstID_PRODUCT = "nopstation.webapi.barcode.inconstidproduct";

  //Order Complete Dialog;

  static const ORDER_PROCESSED =
      "checkout.yourorderhasbeensuccessfullyprocessed";
  static const THANK_YOU = "checkout.thankyou";

  static const NO_INTERNET = "nopstation.webapi.nointernet";
  static const SETTINGS = "nopstation.webapi.settings";
  static const TRY_AGAIN = "nopstation.webapi.tryagain";
  ...
  //search;
  static const ADVANCED_SEARCH = "search.advancedsearch";
  static const COMMON_ALL = "common.all";
  static const COMMON_UPLOAD = "common.upload";
  static const SEARCH_MANUFACTURER = "search.manufacturer";
  static const SEARCH_VENDOR = "search.vendor";
  static const SEARCH_CATEGORY = "search.category";
  static const SEARCH_BUTTON = "search.button";
  static const AUTOMATICALLY_SEARCH_SUBCATEGORIES =
      "search.includesubcategories";
  static const SEARCH_PRICE_RANGE = "search.pricerange";
  static const SEARCH_TO = "search.pricerange.to";
  static const SEARCH_IN_PRODUCT_DISCRIPTIONS = "search.searchindescriptions";
}
